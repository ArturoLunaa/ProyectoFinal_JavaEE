...
<html>
    <head>
        ...
        <jsp:include page="/WEB-INF/paginas/comunes/head.jsp"/>
         <title>Control de Vendedores</title>
    </head>
    <body>
         <!--Barra de navegación-->
 ...
 <!--Botones de navegacion-->
        <jsp:include page="/WEB-INF/paginas/vendedor/botonesNavegacionVendedores.jsp"/>

        <!--Listado Clientes -->
        <jsp:include page="/WEB-INF/paginas/vendedor/listadoVendedores.jsp"/>
        <!--Footer-->
